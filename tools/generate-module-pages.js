...
const pages = [
  {
    ...
    title: "서비스목록",
    subtitle: "학교관리",
    seed: ["늘봄학교 서비스 사용중", "문자서비스 사용중", "학부모앱 연동"],
  },
  {
  ...
  },
  {
    ...
    title: "신청목록",
    subtitle: "환불/취소관리",
    seed: ["2월 환불 요청", "강좌 취소 요청", "부분 환불 검토"],
  },
  {
    file: "fund-targets.html",
    key: "fund-target",
    title: "목록",
    subtitle: "지원금관리 > 대상자관리",
    seed: ["지원금 대상자 등록", "대상자 자격 변경", "대상자 제외 처리"],
  },
  {
    file: "fund-apps.html",
    key: "fund-app",
    title: "목록",
    subtitle: "지원금관리 > 수강자관리",
    seed: ["지원금 수강자 배정", "지원금 수강자 검증", "지원금 수강자 변경"],
  },
  {
    file: "fund-config.html",
    key: "fund-cfg",
    title: "지원금설정",
    subtitle: "지원금관리",
    seed: ["월 지원한도 설정", "지원비율 설정", "정산주기 설정"],
  },
  {
    file: "fund-rank.html",
    key: "fund-rank",
    title: "자유수강권 > 순위구분설정",
    subtitle: "지원금관리",
    seed: ["우선순위 그룹 A", "우선순위 그룹 B", "우선순위 그룹 C"],
  },
  {
    file: "teacher.html",
    key: "teacher",
    title: "목록",
    subtitle: "강사관리",
    seed: ["강사 권한 설정", "강사 비밀번호 초기화", "강사 변경 처리"],
  },
  {
    file: "survey.html",
    key: "survey",
    title: "목록",
    subtitle: "설문",
    seed: ["수강만족도 설문", "학부모 만족도 설문", "운영개선 설문"],
  },
  {
    file: "survey-sample.html",
    key: "survey-sample",
    title: "목록",
    subtitle: "샘플설문",
    seed: ["기본형 샘플 설문", "만족도 샘플 설문", "수요조사 샘플 설문"],
  },
  {
    file: "cfg-basic.html",
    key: "cfg-basic",
    title: "기본설정",
    subtitle: "환경설정",
    seed: ["학교정보 설정", "운영기간 설정", "기본 안내문 설정"],
  },
  {
    file: "cfg-period.html",
    key: "cfg-period",
    title: "신청기간 > 목록",
    subtitle: "환경설정",
    seed: ["2월 신청기간", "3월 신청기간", "돌봄 신청기간"],
  },
  {
    file: "cfg-lecture-time.html",
    key: "cfg-lecture-time",
    title: "강의시간 설정",
    subtitle: "환경설정",
    seed: ["월 1-2교시", "화 3-4교시", "방과후 시간대"],
  },
  {
    file: "cfg-division.html",
    key: "cfg-division",
    title: "강좌구분 설정",
    subtitle: "환경설정",
    seed: ["방과후", "맞춤형", "돌봄"],
  },
  {
    ...
    title: "중복제한그룹 설정",
    subtitle: "환경설정",
    seed: ["영역 중복 제한 그룹", "시간 중복 제한 그룹", "대상학년 중복 제한"],
  },
  {
    file: "cfg-verify.html",
    key: "cfg-verify",
    title: "학적검증",
    subtitle: "환경설정",
    seed: ["학적 데이터 동기화", "검증 오류 목록 확인", "검증 규칙 설정"],
  },
  {
    file: "cfg-neis.html",
    key: "cfg-neis",
    title: "강사 목록",
    subtitle: "나이스/에듀파인 설정",
    seed: ["강사 일괄등록 템플릿", "에듀파인 연동 설정", "나이스 연동 상태"],
  },
  {
    ...
    title: "알림목록",
    subtitle: "알림관리",
    seed: ["시스템 점검 공지", "신청기간 안내", "강좌변경 안내"],
  },
];
